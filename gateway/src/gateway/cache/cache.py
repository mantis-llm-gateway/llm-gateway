...
class PromptCache:
    """Exact-match prompt cache. Will become the orchestrator for exact + semantic later."""
    ...
    def get(self, prompt: str) -> str | None:
        """
        TODO: Backend failures will be raised (contract TBD with Redis adapter).
        """
    ...
    def _key(self, prompt: str) -> str:
        ...
        hashed_prompt = hashlib.sha256(normalized.encode("utf-8")).hexdigest()
